...
package pl.project13.git;

import org.apache.http.client.utils.URIBuilder;
import org.jetbrains.annotations.NotNull;
import pl.project13.git.log.LoggerBridge;
import pl.project13.git.util.PropertyManager;
...
public abstract class GitDataProvider implements GitProvider {
  ...
  protected GitDescribeConfig gitDescribe = new DefaultGitDescribeConfig();
   ...
   */
  public String determineBranchName(Map<String, String> env) throws GitCommitIdExecutionException {
   ...
   * @throws GitCommitIdExecutionException
     */
  public static String stripCredentialsFromOriginUrl(String gitRemoteString) throws GitCommitIdExecutionException {
