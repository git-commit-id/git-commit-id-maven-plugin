...
public class UriUserInfoRemoverTest {
  ...
  public void testStripCrecentialsFromOriginUrl(String input, String expected) throws GitException {
    String result = UriUserInfoRemover.stripCredentialsFromOriginUrl(input);
